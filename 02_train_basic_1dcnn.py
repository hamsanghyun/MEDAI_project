...
# ============================================================
# 4. Basic 1D-CNN 모델 정의
# ============================================================

def build_basic_1dcnn(input_shape=(4096, 12)):
...
model = build_basic_1dcnn(INPUT_SHAPE)
...
checkpoint_path = RESULT_DIR / "best_basic_1dcnn.keras"
...
history_df.to_csv(RESULT_DIR / "training_history_basic_1dcnn.csv", index=False, encoding="utf-8-sig")
...
plt.legend()
plt.tight_layout()
plt.savefig(RESULT_DIR / "loss_curve_basic_1dcnn.png", dpi=200)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(RESULT_DIR / "auprc_curve_basic_1dcnn.png", dpi=200)
plt.close()


# ============================================================
# 8. Best model 로드 후 test 평가
# ============================================================
...
metrics_df.to_csv(RESULT_DIR / "test_metrics_basic_1dcnn.csv", index=False, encoding="utf-8-sig")

print("\n===== Test Metrics: Basic 1D-CNN =====")
print(metrics_df)
...
cm_df.to_csv(RESULT_DIR / "confusion_matrix_basic_1dcnn.csv", encoding="utf-8-sig")
...
plt.tight_layout()
plt.savefig(RESULT_DIR / "confusion_matrix_basic_1dcnn.png", dpi=200)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(RESULT_DIR / "roc_curve_basic_1dcnn.png", dpi=200)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(RESULT_DIR / "pr_curve_basic_1dcnn.png", dpi=200)
plt.close()
...
pred_df.to_csv(RESULT_DIR / "test_predictions_basic_1dcnn.csv", index=False, encoding="utf-8-sig")

print(f"\n결과 저장 폴더: {RESULT_DIR}")
print("Basic 1D-CNN 학습 및 평가 완료")